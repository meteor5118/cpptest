...
${OBJECTDIR}/is_connected_node_in_binary_tree.o: is_connected_node_in_binary_tree.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/is_connected_node_in_binary_tree.o is_connected_node_in_binary_tree.cpp
...
${OBJECTDIR}/merge_two_sorted_lists_2.o: merge_two_sorted_lists_2.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/merge_two_sorted_lists_2.o merge_two_sorted_lists_2.cpp
